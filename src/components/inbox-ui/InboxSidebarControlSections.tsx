...
export function InboxSidebarCurrentViewSection({
  ...
  return (
    <div className="px-4 py-4">
      <div className="rounded-[24px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-4 shadow-[0_12px_28px_rgba(15,23,42,0.05)]">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            type="button"
            onClick={onSync}
            className="inline-flex items-center gap-2 rounded-2xl bg-[#253858] px-3.5 py-2.5 text-[12px] font-semibold text-white transition hover:bg-[#1f2f4d]"
          >
            <RefreshCw
              className={cn(
                'h-4 w-4',
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3.5 py-2.5 text-[12px] font-semibold text-slate-700 transition hover:border-slate-300 hover:text-slate-950"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-3.5 py-2.5 text-[12px] font-semibold text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-100"
          >
